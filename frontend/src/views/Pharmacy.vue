    ...
    <b-tabs card>
      ...
      <div class="container-child-1">
        <b-form>
            ...
            <b-form-input v-model='name' class="textBox" disabled></b-form-input>
            <label class="labelBox"><b>Average points:</b></label>
            <b-form-input v-model="this.avgRating" class="textBox" disabled></b-form-input> 
            <label class="labelBox"><b>Address:</b></label>  
            <div class="parent">
              <label class="labelBox"><b>State:</b></label>
              <b-form-input id="input-small" size="sm" v-model="address.state" class="textBox" disabled></b-form-input>
              <label class="labelBox"><b>City:</b></label>
              <b-form-input id="input-small" size="sm" v-model="address.city" class="textBox" disabled></b-form-input>
              <label class="labelBox"><b>Street:</b></label>
              <b-form-input id="input-small" size="sm" v-model="address.street" class="textBox" disabled></b-form-input>
              <label class="labelBox"><b>Number:</b></label>
              <b-form-input id="input-small" size="sm" v-model="address.number" class="textBox" disabled></b-form-input>
              <label class="labelBox"><b>Postal code:</b></label>
              <b-form-input id="input-small" size="sm" v-model="address.postal" class="textBox" disabled></b-form-input>
              </div> 
        </b-form>
      </div>
    </div>
