							...
							<div class="col-12 col-sm-6 col-md-6 col-lg-3">
								<div class="card h-100 mb-4">                    
									<div class="card-header">                                
										<h5 class="card-title m-0 p-0 font-weight-bolder text-secondary"> 
                      Brufen
                    </h5>
									</div>
									<div class="card-body text-left">
										<p class="card-text">Type: lek za bolove</p>
                    <p class="card-text">Available in: </p>
									</div>
									<div class="card-footer"><a class="btn btn-warning">Reserve</a></div>
								</div>
							</div>
							...
							<div class="col-12 col-sm-6 col-md-6 col-lg-3">
								<div class="card h-100 mb-4">                    
									...
									<div class="card-footer"><a href="#" class="btn btn-warning">Reserve</a></div>
								</div>
							</div>
